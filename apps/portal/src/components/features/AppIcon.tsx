...
/**
 * App icon component that renders the appropriate icon based on the app's icon name.
 */
...
export function AppIcon({ name, className = 'text-white' }: AppIconProps) {
  if (name === 'github') {
    return (
      <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24" className={className}>
        <path
          fillRule="evenodd"
